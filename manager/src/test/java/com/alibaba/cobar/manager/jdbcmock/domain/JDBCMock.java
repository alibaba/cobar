...
import static com.alibaba.cobar.manager.jdbcmock.macher.SQLEquals.sqlEquals;
...
public class JDBCMock {
    ...
    public JDBCMock() {
        ...
        rsVersion = EasyMock.createMock(ResultSet.class);
    ...
    public ResultSet showDataNodes() {
        ...
        try {
            ...
            expectLastCall().andReturn("circe").times(1);
            expectLastCall().andReturn("cndb").times(1);
            expectLastCall().andReturn("dubbo").times(1);
            expectLastCall().andReturn("napoli").times(1);
            expectLastCall().andReturn("offer[0]").times(1);
            expectLastCall().andReturn("offer[1]").times(1);

            tmp.getString(DS);
            expectLastCall().andReturn("circe").times(1);
            expectLastCall().andReturn("cndb_master,cndn_slave").times(1);
            expectLastCall().andReturn("dubbo_master,dubbo_slave").times(1);
            expectLastCall().andReturn("napoli_master,napoli_slave").times(1);
            expectLastCall().andReturn("offer[0]_master,offer[0]_slave").times(1);
            expectLastCall().andReturn("offer[1]_master,offer[1]_slave").times(1);
            ...
            tmp.getString(TYPE);
            expectLastCall().andReturn("mysql").times(1);
            expectLastCall().andReturn("mysql").times(1);
            expectLastCall().andReturn("mysql").times(1);
            expectLastCall().andReturn("mysql").times(1);
            expectLastCall().andReturn("mysql").times(1);
            ...
            tmp.getInt(SIZE);
            expectLastCall().andReturn(16).times(1);
            expectLastCall().andReturn(16).times(1);
            expectLastCall().andReturn(16).times(1);
            expectLastCall().andReturn(16).times(1);
            expectLastCall().andReturn(16).times(1);
    ...
    public void showTimeStartup() {
        ...
        try {
            expect(tmp.next()).andReturn(true).times(1);
            expect(tmp.next()).andReturn(false).times(1);

            expect(tmp.getString(TIMESTAMP)).andReturn("1314238929709").times(1);
    ...
    public ResultSet showVersion() {
        ...
        try {
            ...
            expectLastCall().andReturn("5.1.48-cobar-1.2.3").times(1);
    ...
    public ResultSet showThreadPool() {
        ...
        try {
            ...
            expectLastCall().andReturn("Assistant").times(1);
            expectLastCall().andReturn("Checker").times(1);
            expectLastCall().andReturn("Manager").times(1);
            expectLastCall().andReturn("Processor0-C").times(1);
            expectLastCall().andReturn("Processor0-S").times(1);
            expectLastCall().andReturn("Processor1-C").times(1);
            expectLastCall().andReturn("Processor1-S").times(1);
            expectLastCall().andReturn("Processor2-C").times(1);
            expectLastCall().andReturn("Processor2-S").times(1);
            expectLastCall().andReturn("Processor3-C").times(1);
            expectLastCall().andReturn("Processor3-S").times(1);
            expectLastCall().andReturn("Processor4-C").times(1);
            expectLastCall().andReturn("Processor4-S").times(1);
            expectLastCall().andReturn("Processor5-C").times(1);
            expectLastCall().andReturn("Processor5-S").times(1);
            expectLastCall().andReturn("Processor6-C").times(1);
            expectLastCall().andReturn("Processor6-S").times(1);
            expectLastCall().andReturn("Processor7-C").times(1);
            expectLastCall().andReturn("Processor7-S").times(1);

            tmp.getInt(POOL_SIZE);
            expectLastCall().andReturn(8).times(1);
            expectLastCall().andReturn(8).times(1);
            expectLastCall().andReturn(16).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
            ...
            expectLastCall().andReturn(44254).times(1);
            expectLastCall().andReturn(28529).times(1);
            expectLastCall().andReturn(6437).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
            ...
            expectLastCall().andReturn(44254).times(1);
            expectLastCall().andReturn(28529).times(1);
            expectLastCall().andReturn(6438).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
    ...
    public ResultSet showDataSources() {
        ...
        try {
            ...
            expectLastCall().andReturn("circe").times(1);
            expectLastCall().andReturn("cndb_master").times(1);
            expectLastCall().andReturn("cndb_slave").times(1);
            expectLastCall().andReturn("dubbo_master").times(1);
            expectLastCall().andReturn("dubbo_slave").times(1);
            expectLastCall().andReturn("napoli_master").times(1);
            expectLastCall().andReturn("napoli_slave").times(1);
            expectLastCall().andReturn("offer_master[0]").times(1);
            expectLastCall().andReturn("offer_master[1]").times(1);
            expectLastCall().andReturn("offer_slave[0]").times(1);
            expectLastCall().andReturn("offer_slave[1]").times(1);
            ...
            expectLastCall().andReturn("10.249.192.239").times(1);
            expectLastCall().andReturn("10.20.153.177").times(1);
            expectLastCall().andReturn("10.20.153.177").times(1);
            expectLastCall().andReturn("10.20.153.177").times(1);
            expectLastCall().andReturn("10.20.153.177").times(1);
            expectLastCall().andReturn("10.20.153.177").times(1);
            ...
            tmp.getInt(DS_PORT);
            expectLastCall().andReturn(3306).times(1);
            expectLastCall().andReturn(3306).times(1);
            expectLastCall().andReturn(3306).times(1);
            expectLastCall().andReturn(3306).times(1);
            expectLastCall().andReturn(3306).times(1);
            ...
            expectLastCall().andReturn("circe0").times(1);
            expectLastCall().andReturn("offer1").times(1);
            expectLastCall().andReturn("offer1").times(1);
            expectLastCall().andReturn("offer2").times(1);
            expectLastCall().andReturn("offer2").times(1);
            expectLastCall().andReturn("offer1").times(1);
            expectLastCall().andReturn("offer1").times(1);
            expectLastCall().andReturn("offer1").times(1);
            ...
            expectLastCall().andReturn("UTF-8").times(1);
            expectLastCall().andReturn("UTF-8").times(1);
            expectLastCall().andReturn("UTF-8").times(1);
            expectLastCall().andReturn("UTF-8").times(1);
            expectLastCall().andReturn("UTF-8").times(1);
    ...
    public ResultSet showProcessor() {
        ...
        try {
            ...
            expectLastCall().andReturn("Processor0").times(1);
            expectLastCall().andReturn("Processor1").times(1);
            expectLastCall().andReturn("Processor2").times(1);
            expectLastCall().andReturn("Processor3").times(1);
            expectLastCall().andReturn("Processor4").times(1);
            expectLastCall().andReturn("Processor5").times(1);
            expectLastCall().andReturn("Processor6").times(1);
            expectLastCall().andReturn("Processor7").times(1);

            tmp.getLong(P_NET_IN);
            expectLastCall().andReturn(10617).times(1);
            expectLastCall().andReturn(91631).times(1);
            expectLastCall().andReturn(24969).times(1);
            expectLastCall().andReturn(10870).times(1);
            expectLastCall().andReturn(10496).times(1);
            expectLastCall().andReturn(13208).times(1);
            expectLastCall().andReturn(42190).times(1);
            expectLastCall().andReturn(11818).times(1);

            tmp.getLong(P_NET_OUT);
            expectLastCall().andReturn(62371).times(1);
            expectLastCall().andReturn(2135856).times(1);
            expectLastCall().andReturn(443916).times(1);
            expectLastCall().andReturn(105434).times(1);
            expectLastCall().andReturn(52389).times(1);
            expectLastCall().andReturn(338870).times(1);
            expectLastCall().andReturn(1063047).times(1);
            expectLastCall().andReturn(144475).times(1);

            tmp.getLong(REQUEST_COUNT);
            expectLastCall().andReturn(89).times(1);
            expectLastCall().andReturn(4319).times(1);
            expectLastCall().andReturn(733).times(1);
            expectLastCall().andReturn(98).times(1);
            expectLastCall().andReturn(86).times(1);
            expectLastCall().andReturn(164).times(1);
            expectLastCall().andReturn(1594).times(1);
            expectLastCall().andReturn(146).times(1);
            ...
            expectLastCall().andReturn(4096).times(1);
            expectLastCall().andReturn(4096).times(1);
            expectLastCall().andReturn(4096).times(1);
            expectLastCall().andReturn(4096).times(1);
            expectLastCall().andReturn(4096).times(1);
    ...
    public ResultSet showCommand() {
        ...
        try {
            ...
            tmp.getLong(QUERY);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(5).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
            expectLastCall().andReturn(0).times(1);
    ...
    public ResultSet showConnection() {
        ...
        try {
            ...
            tmp.getLong(ID);
            expectLastCall().andReturn(50503845).times(1);
            expectLastCall().andReturn(1909417519).times(1);

            tmp.getString(HOST);
            expectLastCall().andReturn("10.16.28.20").times(1);
            expectLastCall().andReturn("10.16.200.82").times(1);

            tmp.getInt(PORT);
            expectLastCall().andReturn(1606).times(1);
            expectLastCall().andReturn(50173).times(1);

            tmp.getInt(LOCAL_PORT);
            expectLastCall().andReturn(9066).times(1);
            expectLastCall().andReturn(9066).times(1);
            ...
            expectLastCall().andReturn("latin1").times(1);
            expectLastCall().andReturn("utf8").times(1);

            tmp.getLong(C_NET_IN);
            expectLastCall().andReturn(465).times(1);
            expectLastCall().andReturn(1150).times(1);

            tmp.getLong(C_NET_OUT);
            expectLastCall().andReturn(51483).times(1);
            expectLastCall().andReturn(1150).times(1);

            tmp.getLong(ALIVE_TIME);
            expectLastCall().andReturn(24984).times(1);
            expectLastCall().andReturn(52).times(1);
            ...
            expectLastCall().andReturn(2048).times(1);
            expectLastCall().andReturn(2048).times(1);
    ...
    public ResultSet showConnectionSql() {
        ...
        try {
            ...
            expectLastCall().andReturn("1314693533501").times(1);
            
            tmp.getString(EXECUTE_TIME);
            expectLastCall().andReturn("0").times(1);

            tmp.getString(4);
            expectLastCall().andReturn("show @@connection.sql").times(1);
    ...
    public ResultSet showSqlExecute() {
        ...
        try {
            ...
            tmp.getLong(E_SQL);
            expectLastCall().andReturn(1000).times(1);
            expectLastCall().andReturn(2000).times(1);
            expectLastCall().andReturn(3000).times(1);

            tmp.getLong(E_EXECUTE);
            expectLastCall().andReturn(100).times(1);
            expectLastCall().andReturn(200).times(1);
            expectLastCall().andReturn(300).times(1);

            tmp.getDouble(E_TIME);
            expectLastCall().andReturn(989.9).times(1);
            expectLastCall().andReturn(989.9).times(1);
            expectLastCall().andReturn(989.9).times(1);

            tmp.getDouble(E_MAX_TIME);
            expectLastCall().andReturn(8.8).times(1);
            expectLastCall().andReturn(8.8).times(1);
            expectLastCall().andReturn(8.8).times(1);
    ...
    public ResultSet showSqlSlow() {
        ...
        try {
            ...
            expectLastCall().andReturn(213.2).times(1);
            expectLastCall().andReturn(213.2).times(1);
            expectLastCall().andReturn(213.2).times(1);

            tmp.getString(S_DATA_SOURCE);
            expectLastCall().andReturn("mysql_1").times(1);
            expectLastCall().andReturn("mysql_1").times(1);
            expectLastCall().andReturn("mysql_1").times(1);

            tmp.getString(S_EXECUTE_TIMESTAMP);
            expectLastCall().andReturn("1279188420682").times(1);
            expectLastCall().andReturn("1279188420682").times(1);
            expectLastCall().andReturn("1279188420682").times(1);

            tmp.getString(S_SQL);
            expectLastCall().andReturn("select * from offer limit 1").times(1);
            expectLastCall().andReturn("select * from offer limit 1").times(1);
            expectLastCall().andReturn("select * from offer limit 1").times(1);
    ...
    public ResultSet showParser() {
        ...
        try {
            ...
            expectLastCall().andReturn(11).times(1);

            tmp.getDouble(TIME_COUNT);
            expectLastCall().andReturn(12).times(1);

            tmp.getFloat(MAX_PARSE_TIME);
            expectLastCall().andReturn(13).times(1);

            tmp.getLong(MAX_PARSE_SQL_ID);
            expectLastCall().andReturn(14).times(1);

            tmp.getLong(CACHED_COUNT);
            expectLastCall().andReturn(15).times(1);
    ...
    public ResultSet showServer() {
        ...
        try {
            ...
            expectLastCall().andReturn("1d 5h 42m").times(1);

            tmp.getString(USED_MEMORY);
            expectLastCall().andReturn("367532544").times(1);

            tmp.getString(TOTAL_MEMORY);
            expectLastCall().andReturn("2093809664").times(1);

            tmp.getString(MAX_MEMORY);
            expectLastCall().andReturn("2093809644").times(1);

            tmp.getString(RELOAD_TIME);
            expectLastCall().andReturn("1315202090992").times(1);
            
            tmp.getString(ROLLBACK_TIME);
            expectLastCall().andReturn("1315202100028").times(1);
            
            tmp.getString(STATUS);
            expectLastCall().andReturn("RUNNING").times(1);
    ...
    public ResultSet showSqlDetail() {
        ...
        try {
            ...
            expectLastCall().andReturn(123).times(1);
            expectLastCall().andReturn(123).times(1);
            expectLastCall().andReturn(123).times(1);

            tmp.getDouble(D_TIME);
            expectLastCall().andReturn(2.3).times(1);
            expectLastCall().andReturn(2.3).times(1);
            expectLastCall().andReturn(2.3).times(1);

            tmp.getString(D_LAST_EXECUTE_TIMESTAMP);
            expectLastCall().andReturn("1279188420602").times(1);
            expectLastCall().andReturn("1279188420602").times(1);
            expectLastCall().andReturn("1279188420602").times(1);

            tmp.getDouble(D_LAST_TIME);
            expectLastCall().andReturn(3.42).times(1);
            expectLastCall().andReturn(3.42).times(1);
            expectLastCall().andReturn(3.42).times(1);
    ...
    public ResultSet showSql() {
        ...
        try {
            ...
            expectLastCall().andReturn("insert into T...").times(1);
